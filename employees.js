const employees = [
  ...
  },
  {
    "rank": 29,
    "name": "Svetlana Gusev",
    "role": "Software Engineer (THDU.Services)",
    "avatarStyle": "background-image:url('https://randomuser.me/api/portraits/women/71.jpg')",
    "stats": [
      {
        "icon": "Education",
        "count": 2,
...
function renderEmployeeList() {
          ...
          <table class="activityTable_2943a085">
            ...
            <tbody>${emp.activities.map(a => `
              <tr>
                ...
                <td class="activityDate_2943a085">${a.date}</td>
                <td class="activityPoints_2943a085">${a.points}</td>
              </tr>`).join('')}
            </tbody>
          </table>
        </div>`
          ...
          <div class="rowMain_2943a085">
            <div class="rowLeft_2943a085">
              ...
              <div class="info_2943a085">
                ...
                <span class="role_2943a085">${emp.role}</span>
              </div>
            </div>
            <div class="rowRight_2943a085">
              <div class="categoryStats_2943a085">${statsHtml}</div>
              ...
              <button class="expandButton_2943a085" aria-label="Expand">
                <i data-icon-name="ChevronDown" aria-hidden="true" class="root-203"></i>
              </button>
            </div>
          </div>
        </div>
  ...
  container.addEventListener('click', e => {
    const btn = e.target.closest('.expandButton_2943a085');
    if (!btn) return;
    const row = btn.closest('.userRowContainer_2943a085');
    row.classList.toggle('expanded_2943a085');
    const icon = btn.querySelector('i');
    const expanded = row.classList.contains('expanded_2943a085');
    icon.setAttribute('data-icon-name', expanded ? 'ChevronUp' : 'ChevronDown');
